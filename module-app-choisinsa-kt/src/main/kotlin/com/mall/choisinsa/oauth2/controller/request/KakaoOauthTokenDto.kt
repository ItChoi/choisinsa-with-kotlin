...
class KakaoOauthTokenDto(
    var tokenType: String,	// 토큰 타입, bearer로 고정
    var accessToken: String, // 사용자 액세스 토큰 값
    /**
     * ID 토큰 값
     ...
     */
    var idToken: String,
    var expiresIn: Integer, // 액세스 토큰과 ID 토큰의 만료 시간(초) 참고: 액세스 토큰과 ID 토큰의 만료 시간은 동일
    var refreshToken: String, // 사용자 리프레시 토큰 값
    var refreshTokenExpiresIn: Integer, // 리프레시 토큰 만료 시간(초)
    /**
